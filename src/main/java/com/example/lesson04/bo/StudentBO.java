...
public class StudentBO {
	...
	public StudentEntity updateStudentDreamJobById(int id, String dreamJob) {
		StudentEntity student = studentRepository.findById(id).orElse(null); // Optional 객체
		if (student != null) {
...
//		}
		...
		studentOptional.ifPresent(s -> studentRepository.delete(s)); // 객체가 있으면 수행하고 null이면 수행 안함
	}
}
